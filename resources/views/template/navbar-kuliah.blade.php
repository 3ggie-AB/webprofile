<header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.html"><span>{{ $bloghead }}</span></span></a></h1>

      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link" href="/">Home</a></li>

          <li class="dropdown active"><a href="menu/pendidikan/"><span>Pendidikan</span> <i
          ...
          <li><a class="nav-link" href="kontak.html">Kontak Saya</a></li>
        </ul>
