...
@section('body')
    ...
    <main id="main">
        ...
        @component('template.sambutan', [
            'sambutan_title' => 'Kata Pengantar',
            'sambutan_head' => 'Halo Pengunjung !',
            'sambutan_foot' => 'Terima Sudah Berkunjung <br>o((>ω< ))o.',
        ])
            <br>Nama Saya Egi. Saya Sangat Senang Anda berkunjung ke Web Kecil Ini. Dalam Web ini saya
            Menyajikan
            informasi tentang Pengalaman, Jati diri, Ide-ide dan Pemikiran saya. Semoga Kalian Mendapatkan
            Wawasan,
            Ispirasi atau Imajinasi Baru.<br>
            <br>Sebagai Catatan untuk <mark>Pengunjung</mark> : <br> Jangan Menyalahgunakan Informasi yang
            ada disini.
            <br>
            <br>Sebagai Catatan untuk <mark>Diri Sendiri</mark> : <br> di Web Profile Ini, Saya akan Berbagi
            data
